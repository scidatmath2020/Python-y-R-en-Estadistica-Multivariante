...
#iris[iris["Species"]=="versicolor"].head(15)
#print(iris)
...
colores = pd.DataFrame({"Cod":["red","blue","green"],
...
plt.scatter(iris["Petal.Length"],iris["Petal.Width"],
            s=200,c=iris["Cod"],marker='.',alpha=0.5)
...
fig = px.scatter_3d(iris,x="Sepal.Length",
                    y="Sepal.Width",
                    z="Petal.Width",
                    color="Species")
plot(fig)
...
iris[iris.columns[0:5]].head()

iris[["Sepal.Length","Petal.Length","Sepal.Width","Petal.Width","Species"]]

parallel_coordinates(iris[iris.columns[0:5]],"Species",colormap="rainbow")

parallel_coordinates(iris[["Sepal.Length","Petal.Length","Sepal.Width","Petal.Width","Species"]],
